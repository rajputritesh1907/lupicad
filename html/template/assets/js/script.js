...
(function ($) {
	...
	if ($('.spciality-slider').length > 0) {
		$('.spciality-slider').owlCarousel({
			...
			dots: false,
			nav: true,
			smartSpeed: 2500, // Speed of transition between slides
			...
			autoplay: true,
			autoplayTimeout: 2000, // VERY low timeout to create continuous effect
			autoplayHoverPause: false, // Don’t pause on hover
			animateOut: 'slideOutLeft', // Optional
			animateIn: 'slideInRight', // Optional
			responsive: {
				0: {
					items: 2
				},
